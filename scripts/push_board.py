...
KNOBS = [("TRADING", k) for k in (
    "STRATEGY", "CERTAINTY_LIVE_ENTRIES", "CERTAINTY_MIN_WIN_PROB", "CERTAINTY_MAX_PRICE",
    "CERTAINTY_MAX_SECONDS_LEFT", "FINALS_MAX_PRICE", "CERTAINTY_SIZE_USD",
    "ENTRY_WINDOW", "HOLD_TO_SETTLEMENT", "PREGAME_MAX_HOURS", "MARKET_KINDS", "LEAGUE_MIN_EDGE_OVERRIDE",
...
DEFAULTS = {"STRATEGY": "value", "CERTAINTY_LIVE_ENTRIES": "true", "CERTAINTY_MIN_WIN_PROB": "0.97",
            "CERTAINTY_MAX_PRICE": "0.96", "CERTAINTY_MAX_SECONDS_LEFT": "480", "FINALS_MAX_PRICE": "0.99",
            "CERTAINTY_SIZE_USD": "100", "LEAGUE_MIN_EDGE_OVERRIDE": "0",
            "ENTRY_WINDOW": "any", "HOLD_TO_SETTLEMENT": "false", "PREGAME_MAX_HOURS": "0",
